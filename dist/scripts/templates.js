angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/_compute-resource.html',
    ...
    "</span>\n" +
    "<span ng-if=\"input.amount || defaultValue\" translate>\n" +
    "Limit cannot be more than {{maxLimitRequestRatio}} times request value. (Request: {{request | usageWithUnits : type}},Limit: {{(input.amount ? (input.amount + input.unit) : defaultValue) | usageWithUnits : type}})\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "</fieldset>\n" +
  ...
  $templateCache.put('views/_edit-request-limit.html',
    ...
    "<a href=\"\" ng-click=\"showComputeUnitsHelp()\"><translate>What are</translate>\n" +
    "<span ng-if=\"type === 'cpu'\" translate>millicores</span><span ng-if=\"type === 'memory'\" translate>MiB</span>?</a>\n" +
    "</div>\n" +
    "</ng-form>"
  );
  ...
  $templateCache.put('views/_pod-template-container.html',
    ...
    "<span class=\"pod-template-key\" translate>Image:</span>\n" +
    ...
    "</div>\n" +
    "<div class=\"pod-template-detail word-break\">\n" +
    "<span class=\"pod-template-key\" translate>\n" +
    "Command:\n" +
    "</span>\n" +
    "<span>\n" +
    "<code class=\"command\">\n" +
  ...
  $templateCache.put('views/_templateopt.html',
    ...
    "<div class=\"help-block\" translate>{{parameter.displayName || parameter.name}} is required.</div>\n" +
    "</div>\n" +
    ...
    "<div class=\"help-block\" translate>{{parameter.name}} is required.</div>\n" +
    "</div>\n" +
    "</li>\n" +
    "</ul>\n" +
    "</div>"
  ...
  $templateCache.put('views/_volume-claim-templates.html',
    ...
    "<div class=\"pod-container-name\" translate>Storage claim: {{template.metadata.name}}</div>\n" +
    "<div class=\"pod-template-image icon-row\">\n" +
    "<div class=\"icon-wrap\">\n" +
    "<span class=\"fa fa-lock\" aria-hidden=\"true\"></span>\n" +
    "</div>\n" +
    "<div class=\"pod-template-detail word-break\">\n" +
    "<span class=\"pod-template-key\" translate>Access Modes:</span>\n" +
    ...
    "</div>\n" +
    "<div class=\"pod-template-detail word-break\">\n" +
    "<span class=\"pod-template-key\" translate>Capacity:</span>\n" +
    "<span>\n" +
    ...
    "</div>\n" +
    "<div class=\"pod-template-detail word-break\">\n" +
    "<span class=\"pod-template-key\" translate>Selector:</span>\n" +
  ...
  $templateCache.put('views/_volumes.html',
    ...
    "<span class=\"small text-muted\" translate>(populated by a config map)</span>\n" +
    "</dd>\n" +
    "<dt translate>Config Map:</dt>\n" +
  ...
  $templateCache.put('views/_webhook-trigger-cause.html',
    ...
    "</osc-git-link>\n" +
    "<span ng-if=\"trigger.githubWebHook.revision || trigger.genericWebHook.revision\" translate>\n" +
    "authored by {{trigger.githubWebHook.revision.git.author.name || trigger.genericWebHook.revision.git.author.name}},\n" +
    "</span>\n" +
    "<span ng-if=\"trigger.genericWebHook && !trigger.genericWebHook.revision\" translate>\n" +
  ...
  $templateCache.put('views/about.html',
    ...
    "<div class=\"col-md-12\">\n" +
    "<div class=\"about\">\n" +
    "<h1><translate>Red Hat OpenShift </translate><span class=\"about-reg\">&reg;</span></h1>\n" +
    "<h2 translate>About</h2>\n" +
    "<p>\n" +
    "<a target=\"_blank\" href=\"http://okd.io\" translate>OpenShift</a> <translate>is Red Hat's container application platform that allows developers to quickly develop, host, and scale applications in a cloud environment.</translate>\n" +
    "</p>\n" +
    ...
    "</dd>\n" +
    "<dt translate>OpenShift Web Console:</dt>\n" +
    "<dd>\n" +
    "{{version.console}}\n" +
    "</dd>\n" +
    "</dl>\n" +
    "<p>\n" +
    "The <a target=\"_blank\" ng-href=\"{{'welcome' | helpLink}}\">documentation</a> <translate>helps you learn about OpenShift and start exploring its features. From getting started with creating your first application to trying out more advanced build and deployment techniques, it provides guidance on setting up and managing your OpenShift environment as an application developer.</translate>\n" +
    "</p>\n" +
    "<p>\n" +
    ...
    "<a href=\"command-line\" translate>Command Line Tools</a>.\n" +
    "</p>\n" +
    "<h2 translate>Account</h2>\n" +
    "<p>\n" +
    "<translate>You are currently logged in under the user account </translate><strong>{{user.metadata.name}}</strong>.\n" +
    "</p>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/add-config-volume.html',
    ...
    "<span ng-if=\"!attach.pickKeys\" translate>\n" +
    ...
    "<translate>Mount path must be a valid path to a directory starting with </translate><code>/</code>.\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<translate>Select specific keys and paths</translate>\n" +
    "</label>\n" +
    ...
    "<label class=\"required\" translate>Key</label>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Path must be a relative path. It cannot start with</translate> <code>/</code> <translate>or contain </translate><code>..</code> <translate>path elements.</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<translate>The volume will be mounted into all containers. You can instead</translate>\n" +
    "<a href=\"\" ng-click=\"attach.allContainers = false\" translate>select specific containers</a>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/attach-pvc.html',
    ...
    "<p>\n" +
    "<b translate>A persistent volume claim</b> <translate>is required to attach to this {{kind | humanizeKind}}, but none are loaded on this project.</translate>\n" +
    "</p>\n" +
    ...
    "<translate>To claim storage from a persistent volume, refer to the documentation on </translate><a target=\"_blank\" ng-href=\"{{'persistent_volumes' | helpLink}}\" translate>using persistent volumes</a>.\n" +
    "</p>\n" +
    ...
    "<translate>to volume </translate><strong>{{pvc.spec.volumeName}}</strong>\n" +
    "</span>\n" +
    "</td>\n" +
    "</tr>\n" +
    "</tbody>\n" +
    ...
    "<translate>Select storage to use</translate><span ng-if=\"!outOfClaims\"> <translate>or </translate><a ng-href=\"project/{{project.metadata.name}}/create-pvc\" translate>create storage</a>.</span>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Path must be a relative path. It cannot start with</translate> <code>/</code> <translate>or</translate>\n" +
    "<translate>contain </translate><code>..</code> <translate>path elements.</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
  ...
  $templateCache.put('views/browse/_build-details.html',
    ...
    "<span ng-switch-when=\"Running\"><translate>running for </translate><duration-until-now timestamp=\"build.status.startTimestamp\"></duration-until-now></span>\n" +
    "<span ng-switch-when=\"New\"><translate>waiting for </translate><duration-until-now timestamp=\"build.metadata.creationTimestamp\"></duration-until-now></span>\n" +
    "<span ng-switch-when=\"Pending\"><translate>waiting for </translate><duration-until-now timestamp=\"build.metadata.creationTimestamp\"></duration-until-now></span>\n" +
    "<span ng-switch-default>\n" +
    "<span ng-if=\"build.status.startTimestamp\">{{build.status.startTimestamp | duration : build.status.completionTimestamp}}</span>\n" +
    "<span ng-if=\"!build.status.startTimestamp\"><translate>waited for</translate> {{build.metadata.creationTimestamp | duration : build.status.completionTimestamp}}</span>\n" +
    "</span>\n" +
    "</span>\n" +
    "</dd>\n" +
    ...
    "</div>\n" +
    "</dl>\n" +
    "<h3><translate>Configuration </translate><span class=\"small\" ng-if=\"buildConfigName\"><translate>created from </translate><a href=\"{{build | configURLForResource}}\">{{buildConfigName}}</a></span></h3>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
    ...
    "<dt ng-if-start=\"build.spec.source.git.uri\" translate>Source Repo:</dt>\n" +
  ...
  $templateCache.put('views/browse/_pod-details.html',
    ...
    "(<duration-until-now timestamp=\"pod.status.startTime\"></duration-until-now> <translate>elapsed</translate>)\n" +
    "</span>\n" +
    "</dd>\n" +
    "</dl>\n" +
    "<div>\n" +
  ...
  $templateCache.put('views/browse/_replica-set-details.html',
    ...
    "<button ng-show=\"!rollBackCollapsed && showRollbackAction()\" ng-disabled=\"(deploymentConfigDeploymentsInProgress[deploymentConfigName] | hashSize) > 0\" type=\"button\" class=\"btn btn-default btn-xs\" ng-click=\"rollBackCollapsed = !rollBackCollapsed\" translate>Roll Back</button>\n" +
    ...
    "<span ng-switch-when=\"Running\"><translate>running for </translate><duration-until-now timestamp=\"replicaSet.metadata.creationTimestamp\"></duration-until-now></span>\n" +
    "<span ng-switch-default><translate>waiting for </translate><duration-until-now timestamp=\"replicaSet.metadata.creationTimestamp\"></duration-until-now></span>\n" +
    "</span>\n" +
    "</dd>\n" +
    ...
    "\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=DeploymentConfig&name={{deploymentConfigName}}\" ng-if=\"deploymentConfigName && !deploymentConfigMissing && ('deploymentconfigs' | canI : 'update')\" role=\"button\"><translate>Edit Resource</translate>\n" +
    "<span ng-if=\"!('cpu' | isRequestCalculated : project)\" translate>Requests and</span> <translate>Limits</translate></a>\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=ReplicationController&name={{replicaSet.metadata.name}}\" ng-if=\"!deploymentConfigName && kind === 'ReplicationController' && (resource | canI : 'update')\" role=\"button\"><translate>Edit Resource</translate>\n" +
    "<span ng-if=\"!('cpu' | isRequestCalculated : project)\" translate>Requests and</span> <translate>Limits</translate></a>\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=ReplicaSet&name={{replicaSet.metadata.name}}&group=extensions\" ng-if=\"!deploymentConfigName && kind === 'ReplicaSet' && (resource | canI : 'update')\" role=\"button\"><translate>Edit Resource</translate>\n" +
    "<span ng-if=\"!('cpu' | isRequestCalculated : project)\" translate>Requests and</span> <translate>Limits</translate></a>\n" +
    "</span>\n" +
    "</div>\n" +
    "\n" +
    ...
    "<a ng-if=\"replicaSet.kind === 'ReplicaSet' && deployment\" ng-href=\"project/{{projectName}}/edit/autoscaler?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Add Autoscaler</a>\n" +
  ...
  $templateCache.put('views/browse/build-config.html',
    ...
    "</span>\n" +
    "<small class=\"meta\" ng-if=\"buildConfig\"><translate>created </translate><span am-time-ago=\"buildConfig.metadata.creationTimestamp\"></span></small>\n" +
    "</h1>\n" +
    ...
    "<translate>View the </translate><a ng-href=\"{{(buildConfig | navigateResourceURL) + '?tab=configuration'}}\" translate>Jenkinsfile</a> <translate>to see what stages will run.</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"buildConfig.spec.strategy.jenkinsPipelineStrategy.jenkinsfilePath\">\n" +
    "<translate>View the file </translate><code>{{buildConfig.spec.strategy.jenkinsPipelineStrategy.jenkinsfilePath}}</code> <translate>in the</translate>\n" +
    ...
    "<dt translate>Dockerfile:</dt><dd></dd>\n" +
    "<div ui-ace=\"{\n" +
    "                          mode: 'dockerfile',\n" +
    "                          theme: 'dreamweaver',\n" +
    "                          onLoad: aceLoaded,\n" +
    ...
    "</div>\n" +
    "<div class=\"col-lg-6\">\n" +
    "<h3><translate>Triggers </translate><span class=\"pficon pficon-warning-triangle-o\" ng-if=\"!(secretsVersion | canI : 'list')\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-original-title=\"You do not have access to secrets in this project. Webhook URLs require access to secret information to be used.\"></span></h3>\n" +
    ...
    "<button class=\"btn btn-default\" ng-click=\"saveEnvVars()\" ng-disabled=\"forms.bcEnvVars.$pristine || forms.bcEnvVars.$invalid\" translate>Save</button>\n" +
  ...
  $templateCache.put('views/browse/build.html',
    ...
    "\n" +
    "<button class=\"btn btn-default hidden-xs\" ng-click=\"cancelBuild()\" ng-if=\"!build.metadata.deletionTimestamp && (build | isIncompleteBuild) && (buildsVersion | canI : 'update')\" translate>Cancel Build</button>\n" +
    "<button class=\"btn btn-default hidden-xs\" ng-click=\"cloneBuild()\" ng-hide=\"build.metadata.deletionTimestamp || (build | isIncompleteBuild) || !(buildsCloneVersion | canI : 'create') || (build | isBinaryBuild)\" ng-disabled=\"!canBuild\" translate>Rebuild</button>\n" +
    "\n" +
    "<button type=\"button\" class=\"dropdown-toggle btn btn-default actions-dropdown-btn hidden-xs\" data-toggle=\"dropdown\">\n" +
    "<translate>Actions</translate>\n" +
    "<span class=\"caret\" aria-hidden=\"true\"></span>\n" +
    ...
    "<span class=\"pficon pficon-info\" aria-hidden=\"true\"></span>\n" +
    "<translate>Environment variables can be edited on the </translate><a ng-href=\"{{build | configURLForResource}}?tab=environment\" translate>build configuration</a>.\n" +
    "</p>\n" +
    ...
    "<translate>Log from {{build.status.startTimestamp | date : 'medium'}}</translate>\n" +
    "<span ng-if=\"build.status.completionTimestamp\">\n" +
    "<translate>to {{build.status.completionTimestamp | date : 'medium'}}</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    "</log-viewer>\n" +
    "</uib-tab>\n" +
  ...
  $templateCache.put('views/browse/config-maps.html',
    ...
    "<p translate>No config maps have been added to project {{projectName}}.</p>\n" +
    ...
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all config maps. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/browse/deployment-config.html',
    ...
    "\n" +
    "<button ng-if=\"deploymentConfigsInstantiateVersion | canI : 'create'\" class=\"btn btn-default hidden-xs\" ng-click=\"startLatestDeployment()\" ng-disabled=\"!canDeploy()\" translate>\n" +
    "Deploy\n" +
    "</button>\n" +
    "\n" +
    "<button type=\"button\" class=\"dropdown-toggle btn btn-default actions-dropdown-btn hidden-xs\" data-toggle=\"dropdown\">\n" +
    ...
    "<p ng-if=\"!deploymentConfig.spec.template.spec.volumes.length && !(deploymentConfigsVersion | canI : 'update')\" translate>\n" +
    "none\n" +
    "</p>\n" +
    ...
    "{{warning.message}}\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=DeploymentConfig&name={{deploymentConfig.metadata.name}}\" ng-if=\"warning.reason === 'NoCPURequest' && (deploymentConfigsVersion | canI : 'update')\" role=\"button\"><translate>Edit Resource</translate>\n" +
    "<span ng-if=\"!('cpu' | isRequestCalculated : project)\" translate>Requests and</span><translate> Limits</translate></a>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-if=\"!autoscalers.length\">\n" +
    "<a ng-if=\"horizontalPodAutoscalersVersion | canI : 'create'\" ng-href=\"project/{{projectName}}/edit/autoscaler?kind=DeploymentConfig&name={{deploymentConfig.metadata.name}}\" role=\"button\" translate>Add Autoscaler</a>\n" +
    "<span ng-if=\"!(horizontalPodAutoscalersVersion | canI : 'create')\" translate>Autoscaling is not enabled. There are no autoscalers for this deployment config.</span>\n" +
    "</div>\n" +
    "\n" +
  ...
  $templateCache.put('views/browse/deployment.html',
    ...
    "<a ng-href=\"project/{{project.metadata.name}}/attach-pvc?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Add Storage</a>\n" +
    "</li>\n" +
    "<li ng-if=\"!autoscalers.length && (horizontalPodAutoscalersVersion | canI : 'create')\">\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/edit/autoscaler?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Add Autoscaler</a>\n" +
    "</li>\n" +
    "<li ng-if=\"autoscalers.length === 1 && (horizontalPodAutoscalersVersion | canI : 'update')\">\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/edit/autoscaler?kind=HorizontalPodAutoscaler&group=autoscaling&name={{autoscalers[0].metadata.name}}\" role=\"button\" translate>Edit Autoscaler</a>\n" +
    "</li>\n" +
    "<li ng-if=\"deploymentsVersion | canI : 'update'\">\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Edit Resource Limits</a>\n" +
    "</li>\n" +
    "<li ng-if=\"deploymentsVersion | canI : 'update'\">\n" +
    "<a ng-href=\"{{healthCheckURL}}\" role=\"button\" translate>Edit Health Checks</a>\n" +
    "</li>\n" +
    "<li ng-if=\"deploymentsVersion | canI : 'update'\">\n" +
    "<a ng-href=\"{{deployment | editYamlURL}}\" role=\"button\" translate>Edit YAML</a>\n" +
    "</li>\n" +
    ...
    "<span ng-if=\"deployment.status.availableReplicas\"><translate>{{deployment.status.availableReplicas}} available</translate><span ng-if=\"deployment.status.unavailableReplicas\">,</span></span>\n" +
    "<span ng-if=\"deployment.status.unavailableReplicas\" translate>{{deployment.status.unavailableReplicas}} unavailable</span>\n" +
    "</div>\n" +
    "</dd>\n" +
    "<dt translate>Strategy:</dt>\n" +
    ...
    "</dd>\n" +
    "<dt>\n" +
    "<translate>Revision History Limit:</translate>\n" +
    ...
    "</dd>\n" +
    "<dt>\n" +
    "<translate>Progress Deadline:</translate>\n" +
    ...
    "<div class=\"col-lg-6\">\n" +
    "<h3 translate>Volumes</h3>\n" +
    "<p ng-if=\"!deployment.spec.template.spec.volumes.length && !(deploymentsVersion | canI : 'update')\" translate>\n" +
    "none\n" +
    "</p>\n" +
    ...
    "{{warning.message}}\n" +
    "\n" +
    "<a ng-href=\"project/{{projectName}}/set-limits?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" ng-if=\"warning.reason === 'NoCPURequest' && (deploymentsVersion | canI : 'update')\" role=\"button\"><translate>Edit Resource</translate>\n" +
    "<span ng-if=\"!('cpu' | isRequestCalculated : project)\" translate>Requests and</span> <translate>Limits</translate></a>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-if=\"!autoscalers.length\">\n" +
    "<a ng-if=\"horizontalPodAutoscalersVersion | canI : 'create'\" ng-href=\"project/{{projectName}}/edit/autoscaler?kind=Deployment&name={{deployment.metadata.name}}&group=apps\" role=\"button\" translate>Add Autoscaler</a>\n" +
    "<span ng-if=\"!(horizontalPodAutoscalersVersion | canI : 'create')\" translate>none</span>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-repeat=\"hpa in autoscalers\">\n" +
    "<hpa hpa=\"hpa\" project=\"project\" show-scale-target=\"false\" alerts=\"alerts\"></hpa>\n" +
  ...
  $templateCache.put('views/browse/persistent-volume-claim.html',
    ...
    "</small>\n" +
    "<small class=\"meta\"><translate>created </translate><span am-time-ago=\"pvc.metadata.creationTimestamp\"></span></small>\n" +
    "</h1>\n" +
    ...
    "{{pvc.status.phase}}\n" +
    "<span ng-if=\"pvc.spec.volumeName\"><translate>to volume </translate><strong>{{pvc.spec.volumeName}}</strong></span>\n" +
    "</dd>\n" +
  ...
  $templateCache.put('views/browse/pod.html',
    ...
    "<span class=\"log-timestamps\"><translate>Log from </translate>{{containerStartTime | date : 'medium'}} <span ng-if=\"containerEndTime\"><translate>to </translate>{{containerEndTime | date : 'medium'}}</span></span>\n" +
    "</span>\n" +
    "</span>\n" +
    "</log-viewer>\n" +
    "</uib-tab>\n" +
  ...
  $templateCache.put('views/browse/replica-set.html',
    ...
    "<span class=\"pficon pficon-info\" aria-hidden=\"true\"></span>\n" +
    "<translate>Environment variables can be edited on the deployment</translate>\n" +
  ...
  $templateCache.put('views/browse/route.html',
    ...
    "<span class=\"pficon pficon-info\" aria-hidden=\"true\"></span>\n" +
    "<translate>The DNS admin should set up a CNAME from the route's hostname, {{ingress.host}}, to the router's canonical hostname, {{ingress.routerCanonicalHostname}}.</translate>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/browse/routes.html',
    ...
    "<p translate>No routes have been added to project {{projectName}}.</p>\n" +
    "<p ng-if=\"project && (routesVersion | canI : 'create') && !filterWithZeroResults\">\n" +
    "<a ng-href=\"project/{{project.metadata.name}}/create-route\" class=\"btn btn-primary btn-lg\" translate>Create Route</a>\n" +
    "</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all routes. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/browse/secret.html',
    ...
    "{{secret.type}}\n" +
    "<small class=\"mar-left-sm\"><a href=\"\" ng-if=\"secret.data\" ng-click=\"view.showSecret = !view.showSecret\">{{view.showSecret ? \"Hide\" : \"Reveal\"}} <translate>Secret</translate></a></small>\n" +
    "</h2>\n" +
  ...
  $templateCache.put('views/browse/service-instance.html',
    ...
    "\n" +
    "<button ng-if=\"editAvailable && (serviceInstancesVersion | canI : 'update')\" class=\"btn btn-default hidden-xs\" ng-click=\"showEditDialog()\" translate>\n" +
    "Edit\n" +
    "</button>\n" +
    "\n" +
    "<button type=\"button\" class=\"dropdown-toggle btn btn-default actions-dropdown-btn hidden-xs\" data-toggle=\"dropdown\">\n" +
    ...
    "</button>\n" +
    "<a href=\"\" class=\"dropdown-toggle actions-dropdown-kebab visible-xs-inline\" data-toggle=\"dropdown\"><i class=\"fa fa-ellipsis-v\" aria-hidden=\"true\"></i><span class=\"sr-only\" translate>Actions</span></a>\n" +
    "<ul class=\"dropdown-menu dropdown-menu-right actions action-button\">\n" +
    "<li class=\"visible-xs-inline\" ng-if=\"editAvailable && (serviceInstancesVersion  | canI : 'update')\">\n" +
    "<a href=\"\" role=\"button\" ng-click=\"showEditDialog()\" translate>Edit</a>\n" +
    "</li>\n" +
    "<li ng-if=\"serviceInstancesVersion | canI : 'update'\">\n" +
    "<a ng-href=\"{{serviceInstance | editYamlURL}}\" role=\"button\" translate>Edit YAML</a>\n" +
    "</li>\n" +
    "<li ng-if=\"serviceInstancesVersion | canI : 'delete'\">\n" +
    "<a href=\"\" ng-click=\"deprovision()\" ng-attr-aria-disabled=\"{{serviceInstance.metadata.deletionTimestamp ? 'true' : undefined}}\" ng-class=\"{ 'disabled-link': serviceInstance.metadata.deletionTimestamp }\" role=\"button\" translate>Delete</a>\n" +
    "</li>\n" +
    "</ul>\n" +
    "</div>\n" +
    "{{displayName}}\n" +
    ...
    "</small>\n" +
    "<div>\n" +
    "<small class=\"meta\"><translate>created </translate><span am-time-ago=\"serviceInstance.metadata.creationTimestamp\"></span></small>\n" +
    "</div>\n" +
    "</h1>\n" +
    ...
    "</dd>\n" +
    "<dt ng-if-start=\"serviceInstance | serviceInstanceConditionMessage\" translate>Status Reason:</dt>\n" +
    "<dd ng-if-end class=\"instance-status-message\">{{serviceInstance | serviceInstanceConditionMessage}}</dd>\n" +
    "</dl>\n" +
    "<div class=\"hidden-lg\">\n" +
    "<h3 ng-if-start=\"serviceClass.spec.description || serviceClass.spec.externalMetadata.longDescription\" translate>Description</h3>\n" +
  ...
  $templateCache.put('views/browse/service.html',
    ...
    "<dd ng-if-end>\n" +
    "<span>\n" +
    "<a ng-href=\"project/{{project.metadata.name}}/create-route?service={{service.metadata.name}}\" ng-if=\"routesVersion | canI : 'create'\" translate>Create route</a>\n" +
    "<span ng-if=\"!(routesVersion | canI : 'create')\"><em translate>None</em></span>\n" +
    "</span>\n" +
    "</dd>\n" +
    "</dl>\n" +
    ...
    "</div>\n" +
    "<p>\n" +
    "<translate>Learn more about </translate><a ng-href=\"{{'routes' | helpLink}}\" target=\"_blank\" translate>routes</a> <translate>and </translate><a ng-href=\"{{'services' | helpLink}}\" target=\"_blank\" translate>services</a>.\n" +
    "</p>\n" +
    "<h3 translate>Pods</h3>\n" +
    "<div>\n" +
  ...
  $templateCache.put('views/browse/stateful-set.html',
    ...
    "<dd>\n" +
    "\n" +
    "<span ng-if=\"(podsForStatefulSet | hashSize) !== statefulSet.spec.replicas\">{{podsForStatefulSet | hashSize}}/</span>{{statefulSet.spec.replicas}} <translate>replica</translate><span ng-if=\"statefulSet.spec.replicas != 1\">s</span>\n" +
    "\n" +
    "</dd>\n" +
    "</dl>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/browse/stateful-sets.html',
    ...
    "<p translate>No stateful sets have been added to project {{projectName}}.</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all stateful sets.</translate> <button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "</td>\n" +
    "<td data-title=\"Replicas\">\n" +
    "<span ng-if=\"(podsByOwnerUID[statefulSet.metadata.uid] | hashSize) !== statefulSet.spec.replicas\">{{podsByOwnerUID[statefulSet.metadata.uid] | hashSize}}/</span>{{statefulSet.spec.replicas}} <translate>replica</translate><span ng-if=\"statefulSet.spec.replicas != 1\">s</span>\n" +
    "\n" +
    "</td>\n" +
    "<td data-title=\"Created\">\n" +
  ...
  $templateCache.put('views/builds.html',
    ...
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all builds. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/catalog/_image.html',
    ...
    "</p>\n" +
    "<p ng-if=\"imageStream | imageStreamTagAnnotation : 'provider' : is.tag.tag\" translate>\n" +
    "Provider: {{imageStream | imageStreamTagAnnotation : 'provider' : is.tag.tag}}\n" +
    "</p>\n" +
    "\n" +
    "<p ng-if=\"imageStream.metadata.namespace !== 'openshift'\" translate>\n" +
  ...
  $templateCache.put('views/catalog/_template.html',
    ...
    "</p>\n" +
    "<p ng-if=\"template | annotation : 'provider'\" translate>\n" +
    "Provider: {{template | annotation : 'provider'}}\n" +
    "</p>\n" +
    "\n" +
    "<p ng-if=\"template.metadata.namespace !== 'openshift'\" translate>\n" +
  ...
  $templateCache.put('views/catalog/catalog.html',
    ...
    "<p class=\"gutter-top\">\n" +
    "<translate>No images or templates are loaded for this project or the shared</translate>\n" +
    "<code translate>openshift</code> <translate>namespace. An image or template is required to add content.</translate>\n" +
    "</p>\n" +
    "<p>\n" +
    "<translate>To add an image stream or template from a file, use the editor in the</translate>\n" +
    "<strong>Import YAML / JSON</strong> <translate>tab, or run the following command:</translate>\n" +
    ...
    "<button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"filter.keyword = ''\" translate>Clear All Filters</button>\n" +
    "</div>\n" +
    ...
    "<h2 class=\"h3\">\n" +
    "<translate>Other {{parentCategory.label}}</translate>\n" +
  ...
  $templateCache.put('views/command-line.html',
    ...
    "<translate>You can download the </translate><code>oc</code> <translate>client tool using the links below. For more information about downloading and installing it, please refer to the </translate><a target=\"_blank\" href=\"{{'get_started_cli' | helpLink}}\" translate>Get Started with the CLI</a> <translate>documentation.</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"!cliDownloadURLPresent\">\n" +
    "<translate>Refer to the </translate><a target=\"_blank\" href=\"{{'get_started_cli' | helpLink}}\" translate>Get Started with the CLI</a> <translate>documentation for instructions about downloading and installing the </translate><code>oc</code> <translate>client tool.</translate>\n" +
    "</span>\n" +
    "<div ng-if=\"cliDownloadURLPresent\">\n" +
    "<label class=\"cli-download-label\"><translate>Download </translate><code>oc</code>:</label>\n" +
    ...
    "</p>\n" +
    "<p>\n" +
    "<translate>After downloading and installing it, you can start by logging in. You are currently logged into this console as </translate><strong>{{user.metadata.name}}</strong>. <translate>If you want to log into the CLI using the same session token:</translate>\n" +
    ...
    "</p>\n" +
    "<p><translate>For other information about the command line tools, check the </translate><a target=\"_blank\" href=\"{{'cli' | helpLink}}\" translate>CLI Reference</a> <translate>and </translate><a target=\"_blank\" href=\"{{'basic_cli_operations' | helpLink}}\" translate>Basic CLI Operations</a>.</p>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/create-config-map.html',
    ...
    "<h1 translate>Create Config Map</h1>\n" +
    "<div class=\"help-block\" translate>\n" +
  ...
  $templateCache.put('views/create-from-url.html',
    ...
    "<p ng-if=\"validationPassed && createDetails.sourceURI\"><translate>Source code from </translate><a href=\"{{createDetails.sourceURI}}\">{{createDetails.sourceURI}}</a> <translate>will be built and deployed unless otherwise specified in the next step.</translate></p>\n" +
  ...
  $templateCache.put('views/create-persistent-volume-claim.html',
    ...
    "<button type=\"submit\" class=\"btn btn-primary btn-lg\" ng-click=\"createPersistentVolumeClaim()\" ng-disabled=\"createPersistentVolumeClaimForm.$invalid || disableInputs\" value=\"\" translate>Create</button>\n" +
    "<a class=\"btn btn-default btn-lg\" href=\"\" ng-click=\"cancel()\" role=\"button\" translate>Cancel</a>\n" +
    "</div>\n" +
    "</fieldset>\n" +
    "</form>\n" +
  ...
  $templateCache.put('views/create/fromimage.html',
    ...
    "<translate>Sample repository for {{imageName}}: </translate>{{image.metadata.annotations.sampleRepo}}<span ng-if=\"image.metadata.annotations.sampleRef\" translate>,ref: {{image.metadata.annotations.sampleRef}}</span><span ng-if=\"image.metadata.annotations.sampleContextDir\" translate>,context dir: {{image.metadata.annotations.sampleContextDir}}</span>\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<label for=\"gitref\" translate>Git Reference</label>\n" +
    "<div>\n" +
    ...
    "<label>\n" +
    "<input type=\"checkbox\" ng-model=\"routing.include\" translate>\n" +
  ...
  $templateCache.put('views/deployments.html',
    ...
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all deployments. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div ng-if=\"!filterWithZeroResults\">\n" +
  ...
  $templateCache.put('views/directives/_build-pipeline-collapsed.html',
    ...
    "<span class=\"component-label\" translate>\n" +
    "Pipeline\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/directives/_build-pipeline-links.html',
    "<div ng-if=\"(build | buildLogURL) && (buildLogsVersion | canI : 'get')\" class=\"pipeline-link\"><a ng-href=\"{{build | buildLogURL}}\" target=\"_blank\" translate>View Log</a></div>"
  );
  ...
  $templateCache.put('views/directives/_edit-command.html',
    "<ng-form name=\"form\">\n" +
    "<div ng-hide=\"input.args.length\"><em translate>No {{type || 'command'}} set.</em></div>\n" +
  ...
  $templateCache.put('views/directives/_edit-probe.html',
    "<ng-form name=\"form\">\n" +
    "<div class=\"form-group\">\n" +
    "<label class=\"required\" translate>Type</label>\n" +
    ...
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "<label ng-attr-for=\"{{id}}-path\" translate>Path</label>\n" +
    "<div>\n" +
    ...
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "<label class=\"required\" translate>Port</label>\n" +
  ...
  $templateCache.put('views/directives/_service-binding.html',
    ...
    "</span>\n" +
    "<small><translate>created </translate><span am-time-ago=\"$ctrl.binding.metadata.creationTimestamp\"></span></small>\n" +
    "</h3>\n" +
    "</div>\n" +
    ...
    "</delete-link>\n" +
    "<a ng-if=\"($ctrl.secretsVersion | canI : 'get') && ($ctrl.binding | isBindingReady)\" ng-href=\"{{$ctrl.binding.spec.secretName | navigateResourceURL : 'Secret' : $ctrl.namespace}}\" translate>\n" +
    "View Secret\n" +
    "</a>\n" +
    "</div>\n" +
    "<div class=\"service-binding-parameters\" ng-if=\"!$ctrl.isOverview && $ctrl.bindParameterSchema.properties\">\n" +
    "<span class=\"component-label\" translate>Parameters</span>\n" +
  ...
  $templateCache.put('views/directives/add-config-to-application.html',
    ...
    "{{ctrl.apiObject.kind | humanizeKind | upperFirst}} <strong>{{ctrl.apiObject.metadata.name}}</strong> <translate>contains keys that are not valid environment variable names. Only {{ctrl.apiObject.kind | humanizeKind}} keys with valid names will be added as environment variables.</translate>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    ...
    "<div class=\"help-block\" ng-show=\"addToApplicationForm.envPrefix.$error.pattern && addToApplicationForm.envPrefix.$touched\" translate>\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<div class=\"control-label\">\n" +
    "<label class=\"required\" translate>Mount Path</label>\n" +
    ...
    "<translate>The mount path is already used. Please choose another mount path.</translate>\n" +
    "</div>\n" +
    "<span class=\"sr-only\" id=\"mount-path-help\" translate>\n" +
    ...
    "<legend ng-if-start=\"ctrl.application.spec.template.spec.containers.length > 1\" translate>Containers:</legend>\n" +
    "<div ng-if-end class=\"form-group container-options\">\n" +
    "<div ng-if=\"ctrl.attachAllContainers\">\n" +
    "<translate>The {{ctrl.apiObject.kind | humanizeKind}} will be added to all containers. You can</translate>\n" +
    "<a href=\"\" ng-click=\"ctrl.attachAllContainers = false\" translate>select specific containers</a>\n" +
    "<translate>instead.</translate>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/bind-service/delete-binding-select-form.html',
    ...
    "<translate>Select a binding to delete from </translate><strong>{{ctrl.displayName}}</strong>\n" +
    "</h3>\n" +
    ...
    "</div>\n" +
    "<div>\n" +
    "<small class=\"text-muted\"><translate>Created </translate><span am-time-ago=\"binding.metadata.creationTimestamp\"></span></small>\n" +
    "</div>\n" +
    "</label>\n" +
    "</div>\n" +
    "</fieldset>\n" +
  ...
  $templateCache.put('views/directives/build-hooks.html',
    ...
    "<dt ng-if-start=\"build.spec.postCommit.command\" translate>Command:</dt>\n" +
    "<dd ng-if-end>\n" +
    "<code class=\"command\">\n" +
    ...
    "</code>\n" +
    "</dd>\n" +
    "<dt ng-if-start=\"build.spec.postCommit.script\" translate>Script:</dt>\n" +
    "<dd ng-if-end>\n" +
    ...
    "</div>\n" +
    "</dd>\n" +
    "<dt ng-if-start=\"build.spec.postCommit.args\" translate>Args:</dt>\n" +
    "<dd ng-if-end>\n" +
    "<code class=\"command\">\n" +
  ...
  $templateCache.put('views/directives/create-secret.html',
    ...
    "<ui-select-match translate>{{$select.selected | upperFirst}} Secret</ui-select-match>\n" +
    ...
    "Name is required.\n" +
    "</div>\n" +
    "<div ng-show=\"secretForm.name.$error.maxlength && secretForm.name.$touched\" class=\"help-block\" translate>\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<label for=\"webhook-secret-key\" class=\"required\" translate>Webhook Secret Key</label>\n" +
    ...
    "<span class=\"input-group-btn\">\n" +
    "<button type=\"button\" class=\"btn btn-default\" ng-click=\"generateWebhookSecretKey()\" translate>Generate</button>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<label for=\"authentification-type\" translate>Authentication Type</label>\n" +
    ...
    "<translate>Use a custom ca.crt file</translate>\n" +
    "</label>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<translate>Use a custom .gitconfig file</translate>\n" +
    "</label>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<translate>Email must be in the form of </translate><var>user@domain</var>.\n" +
    "</div>\n" +
    ...
    "<button class=\"btn btn-primary\" type=\"button\" ng-disabled=\"secretForm.$invalid || secretForm.$pristine || invalidConfigFormat\" ng-click=\"create()\" translate>Create</button>\n" +
  ...
  $templateCache.put('views/directives/delete-button.html',
    "<div class=\"actions\">\n" +
    "\n" +
    "<a href=\"\" ng-click=\"$event.stopPropagation(); openDeleteModal()\" role=\"button\" class=\"action-button\" ng-attr-aria-disabled=\"{{disableDelete ? 'true' : undefined}}\" ng-class=\"{ 'disabled-link': disableDelete }\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i><span class=\"sr-only\" translate>Delete {{kind | humanizeKind}} {{resourceName}}</span></a>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/directives/deploy-image.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<translate>Service account </translate><strong translate>default</strong> <translate>will need image pull authority to deploy images from</translate> <strong>{{istag.namespace}}</strong>. <translate>You can grant authority with the command:</translate>\n" +
    "<p>\n" +
    ...
    "&ndash; <translate>Image search is only available for existing projects.</translate>\n" +
    "</span>\n" +
    "</label>\n" +
    "</div>\n" +
    ...
    "<h2 ng-if=\"loading\" class=\"h2\"><translate>Loading image metadata for </translate><span class=\"word-break\">{{imageName | stripSHA}}</span>...</h2>\n" +
    "</div>\n" +
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<translate>Image </translate><strong>{{import.name}}</strong> <translate>runs as the</translate><strong>root</strong> <translate>user which might not be permitted by your cluster administrator.</translate>\n" +
    "</div>\n" +
    "<h2>\n" +
    ...
    "<button type=\"submit\" class=\"btn btn-primary btn-lg\" ng-click=\"create()\" value=\"\" ng-disabled=\"forms.deployImage.$invalid || nameTaken || disableInputs\" translate>Create</button>\n" +
    ...
    "<p><translate>The image may not exist or it may be in a secure registry. Check that you have entered the image name correctly or </translate><a href=\"\" ng-click=\"openCreateWebhookSecretModal()\" translate>create an image pull secret</a> <translate>with your image registry credentials and try again.</translate></p>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/deployment-donut.html',
    ...
    "</pod-donut>\n" +
    "\n" +
    "<a href=\"\" class=\"sr-only\" ng-click=\"viewPodsForDeployment(rc)\" ng-if=\"(pods | hashSize) > 0\" role=\"button\" translate>\n" +
    ...
    "<span class=\"sr-only\" translate>Scale up</span>\n" +
    "</a>\n" +
    "</div>\n" +
    "<div>\n" +
    "\n" +
    ...
    "<span class=\"nowrap\" translate>min: {{hpa[0].spec.minReplicas || 1}},</span>\n" +
    "<span class=\"nowrap\"><translate>max: {{hpa[0].spec.maxReplicas}}</translate>\n" +
    ...
    "<a ng-href=\"project/{{rc.metadata.namespace}}/quota\" translate>Quota</a>\n" +
    "<translate>limit reached.</translate>\n" +
    "</div>\n" +
    "<div class=\"scaling-details\" ng-if=\"showQuotaWarning\">\n" +
  ...
  $templateCache.put('views/directives/deployment-metrics.html',
    ...
    "</h2>\n" +
    "<p>\n" +
    "<translate>An error occurred getting metrics</translate><span ng-if=\"options.selectedContainer.name\" translate>\n" +
  ...
  $templateCache.put('views/directives/edit-config-map-or-secret.html',
    ...
    "</div>\n" +
    "<div>\n" +
    "<span id=\"key-value-map-name-help\" class=\"help-block\" translate>A unique name for the {{type}} within the project.</span>\n" +
    "</div>\n" +
    ...
    "<p><em translate>The {{type}} has no items.</em></p>\n" +
    "<a href=\"\" ng-click=\"addItem()\" translate>Add Item</a>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/edit-environment-from.html',
    ...
    "<div ng-if=\"!entry.configMapRef.name && !entry.secretRef.name\" translate>\n" +
    ...
    "<translate>Use all keys and values from</translate>\n" +
    "<span ng-if=\"entry.configMapRef.name\" translate>config map {{entry.configMapRef.name}}.</span>\n" +
    "<span ng-if=\"entry.secretRef.name\" translate>secret {{entry.secretRef.name}}.</span>\n" +
    "<span ng-if=\"entry.prefix\"><translate>Names will be prefixed with </translate>\"{{entry.prefix}}\"</span>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<div class=\"help-block\">{{entry.selectedEnvFrom.kind | humanizeKind | upperFirst}} <strong>{{entry.selectedEnvFrom.metadata.name}}</strong> <translate>contains keys that are not valid environment variable names. Only {{entry.selectedEnvFrom.kind | humanizeKind}} keys with valid names will be added as environment variables.</translate>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<label for=\"envfrom-prefix-{{$index}}\" class=\"sr-only\" translate>Prefix</label>\n" +
    ...
    "<span class=\"validation-text\" translate>Please enter a valid prefix.</span>\n" +
    "</span>\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<a href=\"\" ng-click=\"$ctrl.viewOverlayPanel(entry.selectedEnvFrom)\" translate>View Details</a>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>{{$ctrl.overlayPaneEntryDetails.kind | humanizeKind : true}} Details</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    ...
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button ng-click=\"$ctrl.closeOverlayPanel()\" type=\"button\" class=\"btn btn-default\" translate>Close</button>\n" +
    "</div>\n" +
    "</overlay-panel>\n" +
    "</ng-form>"
  );
  ...
  $templateCache.put('views/directives/edit-environment-variables.html',
    ...
    "<h3 translate>Container {{container.name}}</h3>\n" +
    "<div ng-if=\"!$ctrl.canIUpdate || $ctrl.ngReadonly\">\n" +
    "<span ng-if=\"!container.env.length\" translate>\n" +
    ...
    "<button class=\"btn btn-default\" ng-if=\"$ctrl.canIUpdate && !$ctrl.ngReadonly\" ng-click=\"$ctrl.save()\" ng-disabled=\"$ctrl.form.$pristine || $ctrl.form.$invalid\" translate>Save</button>\n" +
    "<a ng-if=\"!$ctrl.form.$pristine\" href=\"\" ng-click=\"$ctrl.clearChanges()\" class=\"mar-left-sm clear-env-changes-link\" translate>Clear Changes</a>\n" +
    "</div>\n" +
    "</form>"
  );
  ...
  $templateCache.put('views/directives/events.html',
    ...
    "<button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"filter.text = ''\" translate>Clear All Filters</button>\n" +
    "</span>\n" +
    "</td>\n" +
  ...
  $templateCache.put('views/directives/header/header.html',
    ...
    "<option value=\"catalog\" translate>Service Catalog</option>\n" +
    "<option value=\"application-console\" translate>Application Console</option>\n" +
    "<option value=\"cluster-console\" translate>Cluster Console</option>\n" +
    "</select>\n" +
    "</div>\n" +
    ...
    "<li role=\"menuitem\"><a ng-href=\"project/{{currentProjectName}}/create?tab=deployImage\" translate>Deploy Image</a></li>\n" +
    "<li ng-if-end role=\"menuitem\"><a ng-href=\"project/{{currentProjectName}}/create?tab=fromFile\" translate>Import YAML / JSON</a></li>\n" +
  ...
  $templateCache.put('views/directives/hpa.html',
    ...
    "<a ng-if=\"{resource: 'horizontalpodautoscalers', group: 'autoscaling'} | canI : 'update'\" ng-href=\"project/{{hpa.metadata.namespace}}/edit/autoscaler?kind=HorizontalPodAutoscaler&group=autoscaling&name={{hpa.metadata.name}}\" role=\"button\" translate>Edit</a>\n" +
    "<span class=\"action-divider\">|</span>\n" +
    ...
    "<dt ng-if-start=\"hpa.spec.targetCPUUtilizationPercentage\" translate>\n" +
    "CPU Request\n" +
    "</dt>\n" +
  ...
  $templateCache.put('views/directives/key-value-editor.html',
    ...
    "<span class=\"validation-text\" translate>Minimum character count is {{keyMinlength}}</span>\n" +
    "</span>\n" +
    ...
    "<span class=\"validation-text\" translate>Minimum character count is {{valueMinlength}}</span>\n" +
    "</span>\n" +
    "</span>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/lifecycle-hook.html',
    ...
    "<span ng-switch=\"type\">\n" +
    "<small ng-switch-when=\"pre\" translate>&ndash; runs before the deployment begins</small>\n" +
    "<small ng-switch-when=\"mid\" translate>&ndash; runs after the previous deployment is scaled down to zero and before the first pod of the new deployment is created</small>\n" +
    "<small ng-switch-when=\"post\" translate>&ndash; runs after the deployment strategy completes</small>\n" +
    "</span>\n" +
    "</h4>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
    ...
    "<translate>{{env.name}} set to key</translate>\n" +
    ...
    "<h5 class=\"container-name\" translate>Container {{tagImage.containerName}}</h5>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
  ...
  $templateCache.put('views/directives/logs/_log-viewer.html',
    ...
    "<a href=\"\" ng-click=\"onScrollTop()\" translate>Go to Top</a>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-if=\"limitReached\" class=\"text-muted\">\n" +
    "<translate>The maximum web console log size has been reached. Use the command-line interface or</translate>\n" +
    "<a href=\"\" ng-click=\"restartLogs()\" translate>reload</a> <translate>the log to see new messages.</translate>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/next-steps.html',
    ...
    "<translate>You are set up to use the example git repository. If you would like to modify the source code, fork the </translate><osc-git-link uri=\"$ctrl.createdBuildConfig.spec.source.git.uri\">{{$ctrl.createdBuildConfig.spec.source.git.uri}}</osc-git-link> <translate>repository to an OpenShift-visible git account and </translate><a href=\"{{$ctrl.createdBuildConfig | editResourceURL}}\"><translate>edit the </translate><strong>{{$ctrl.createdBuildConfig.metadata.name}}</strong> <translate>build config</translate></a> <translate>to point to your fork.</translate>\n" +
    ...
    "<p>\n" +
    "<translate>A GitHub </translate><a target=\"_blank\" href=\"{{'webhooks' | helpLink}}\" translate>webhook trigger</a> <translate>has been created for the </translate><strong>{{$ctrl.createdBuildConfig.metadata.name}}</strong> <translate>build config.</translate>\n" +
    "</p>\n" +
    ...
    "<translate>You can now set up the webhook in the GitHub repository settings if you own it, in</translate> <a target=\"_blank\" class=\"word-break\" href=\"{{$ctrl.createdBuildConfig.spec.source.git.uri | githubLink}}/settings/hooks\">{{$ctrl.createdBuildConfig.spec.source.git.uri | githubLink}}/settings/hooks</a>, <translate>using the following payload URL and specifying a</translate> <i translate>Content type</i> of <code>application/json</code>:\n" +
    "</span>\n" +
    "<span ng-if=\"!($ctrl.createdBuildConfig.spec.source.git.uri | isGithubLink)\">\n" +
    "<translate>Your source does not appear to be a URL to a GitHub repository. If you have a GitHub repository that you want to trigger this build from then use the following payload URL and specifying a </translate><i translate>Content type</i> of <code>application/json</code>:\n" +
    "</span>\n" +
    "</p>\n" +
    ...
    "<h2 class=\"h3\" translate>Applied Parameter Values</h2>\n" +
    ...
    "<span ng-if=\"$ctrl.parameters.generated.length > 1\"><translate>Parameters </translate><span ng-repeat=\"paramName in $ctrl.parameters.generated\">{{paramName}}<span ng-if=\"!$last\">, </span></span> <translate>were generated automatically.</translate></span>\n" +
  ...
  $templateCache.put('views/directives/notifications/header.html',
    ...
    "<div class=\"col-xs-6\" translate>\n" +
    "{{notificationGroup.totalUnread}} Unread\n" +
    "</div>\n" +
    "<div class=\"col-xs-6 text-right\">\n" +
    "<a title=\"All Events\" ng-href=\"project/{{$ctrl.customScope.projectName}}/browse/events\" ng-click=\"$ctrl.customScope.close()\" translate>\n" +
    "View All Events\n" +
    "</a>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/notifications/notification-body.html',
    ...
    "<span class=\"sr-only\" translate>Clear notification</span>\n" +
  ...
  $templateCache.put('views/directives/osc-autoscaling.html',
    ...
    "<translate>Max pods must be greater than or equal to</translate>\n" +
    "<span ng-if=\"autoscaling.minReplicas\" translate>min pods, which is</span>\n" +
  ...
  $templateCache.put('views/directives/osc-file-input.html',
    ...
    "<translate>Browse</translate>&hellip;\n" +
  ...
  $templateCache.put('views/directives/osc-image-summary.html',
    ...
    "<div ng-show=\"resource | annotation:'provider'\" translate>Provider: {{ resource | annotation:'provider' }}</div>\n" +
  ...
  $templateCache.put('views/directives/osc-persistent-volume-claim.html',
    ...
    "<a ng-href=\"project/{{projectName}}/quota\" target=\"_blank\"><translate>View Quota</translate>&nbsp;</a>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<label class=\"required\" translate>Access Mode</label>\n" +
    ...
    "<translate>Single User (RWO)</translate>\n" +
    "</label>\n" +
    "<label class=\"radio-inline\">\n" +
    ...
    "<translate>Shared Access (RWX)</translate>\n" +
    "</label>\n" +
    "<label class=\"radio-inline\">\n" +
    ...
    "<translate>Read Only (ROX)</translate>\n" +
    "</label>\n" +
    "</div>\n" +
    "<div>\n" +
    ...
    "<div class=\"resource-amount\">\n" +
    "<label for=\"claim-amount\" class=\"sr-only\" translate>Amount</label>\n" +
    ...
    "</div>\n" +
    "<div class=\"resource-unit\">\n" +
    "<label class=\"sr-only\" translate>Unit</label>\n" +
    ...
    "<translate>Desired storage capacity.</translate>\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\" translate>Can't be less than {{limits.min | usageWithUnits : 'storage'}}.\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Storage quota will be exceeded. </translate><a ng-href=\"project/{{projectName}}/quota\" target=\"_blank\">View Quota&nbsp;</a>\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/osc-routing-service.html',
    ...
    "<span class=\"help-block\">\n" +
    "<translate>There are no</translate> <span ng-if=\"is-alternate\" translate>additional</span> <translate>services in your project to expose with a route.</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "Weight is a number between 0 and 256 that specifies the relative weight against otherroute services.\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/directives/osc-routing.html',
    ...
    "<translate>You can use </translate><var>*.example.com</var><translate> with routers that support wildcard subdomains.</translate>\n" +
    "</span>\n" +
    "</p>\n" +
    ...
    "<span ng-if=\"!disableWildcards\"><translate>Wildcard subdomains may start with </translate><var>*.</var></span>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Path must start with </translate><code>/</code>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<span class=\"action-divider\">|</span>\n" +
    "<button type=\"button\" class=\"btn btn-link\" ng-click=\"addAlternateService()\" translate>Add Another Service</button>\n" +
    "</span>\n" +
    "</div>\n" +
    ...
    "<button type=\"button\" class=\"btn btn-link\" ng-click=\"controls.hideSlider = true\" translate>edit weights as integers</button>.\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Passthrough routes can't use the insecure traffic policy </translate><var translate>Allow</var>.\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "\n" +
  ...
  $templateCache.put('views/directives/osc-source-secrets.html',
    ...
    "</div>\n" +
    "<div class=\"col-xs-6\">\n" +
    "<label class=\"input-label destination-dir\" translate>\n" +
  ...
  $templateCache.put('views/directives/pod-donut.html',
    ...
    "</span>\n" +
    "</div>\n" +
    "<span ng-if=\"mini && total === 1 && !idled\" class=\"donut-mini-text-name\" translate>pod</span>\n" +
    "<span ng-if=\"mini && total !== 1 && !idled\" class=\"donut-mini-text-name\">\n" +
    "<span ng-if=\"!idled && total > 99\">\n" +
    "{{total}}\n" +
    "</span> <translate>pods</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"mini && idled\" class=\"donut-mini-text-name\" translate>Idle</span>\n" +
    "\n" +
    "<div class=\"sr-only\">\n" +
  ...
  $templateCache.put('views/directives/pod-metrics.html',
    ...
    "<span ng-if=\"metric.containerMetric\" translate>Container Metrics</span>\n" +
    "<span ng-if=\"!metric.containerMetric\" translate>Pod Metrics</span>\n" +
    "</small>\n" +
    "</h2>\n" +
    "\n" +
    "\n" +
    ...
    "<div translate>Available of</div>\n" +
    ...
    "</h1>\n" +
    "<div class=\"available-text pull-left\">\n" +
    "<div><strong translate>Over limit of</strong></div>\n" +
    "<div>{{metric.datasets[0].total}} {{metric.units}}</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/pods-table.html',
    ...
    "<thead>\n" +
    "<tr>\n" +
    "<th translate>{{customNameHeader || 'Name'}}</th>\n" +
    "<th translate>Status</th>\n" +
    ...
    "<tr><td colspan=\"{{activePods ? 6 : 5}}\"><em translate>{{emptyMessage || 'No pods to show'}}</em></td></tr>\n" +
    "</tbody>\n" +
    "<tbody ng-if=\"sortedPods.length\">\n" +
  ...
  $templateCache.put('views/directives/replicas.html',
    ...
    "<span ng-if=\"status === undefined\"><translate>{{spec}} replica</translate><span ng-if=\"spec !== 1\">s</span></span>\n" +
  ...
  $templateCache.put('views/directives/resource-service-bindings.html',
    ...
    "<div>\n" +
    "<a ng-href=\"{{project | catalogURL}}\" translate>Browse Catalog</a>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/service-instance-bindings.html',
    ...
    "<h3 ng-if=\"$ctrl.showHeader\" translate>Bindings</h3>\n" +
  ...
  $templateCache.put('views/directives/traffic-table.html',
    ...
    "<thead>\n" +
    "<tr>\n" +
    "<th><translate>{{customNameHeader || 'Route'}}</translate><span ng-if=\"showNodePorts\" translate> / Node Port</span></th>\n" +
    ...
    "<td data-title=\"{{customNameHeader || 'Route'}}{{ showNodePorts ? ' / Node Port' : '' }}\">\n" +
    "<span ng-if=\"!port.nodePort\" class=\"text-muted\" translate>none</span>\n" +
    "<span ng-if=\"port.nodePort\">{{port.nodePort}}</span>\n" +
    "</td>\n" +
    "<td role=\"presentation\" class=\"text-muted arrow\"></td>\n" +
    "<td data-title=\"Service Port\">\n" +
  ...
  $templateCache.put('views/edit/autoscaler.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "<translate>This autoscaler uses a newer API, consider editing it with the</translate>\n" +
    "<a href=\"command-line\" target=\"_blank\" translate>command line tools</a>.\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/edit/build-config.html',
    ...
    "<span ng-if=\"!view.advancedOptions\"><translate>If your Git repository is private, view the </translate><a href=\"\" ng-click=\"view.advancedOptions = true\" translate>advanced options</a> to set up authentication.</span>\n" +
    "</div>\n" +
    ...
    "</h3>\n" +
    "<div class=\"form-group\">\n" +
    "<label class=\"sr-only\" translate>Run policy type</label>\n" +
  ...
  $templateCache.put('views/edit/config-map.html',
    ...
    "<div class=\"help-block\" translate>\n" +
    "Config maps hold key-value pairs that can be used in pods to read applicationconfiguration.\n" +
    "</div>\n" +
    "<div class=\"mar-top-xl\">\n" +
    "<div ng-if=\"!loaded\" translate>Loading...</div>\n" +
  ...
  $templateCache.put('views/edit/deployment-config.html',
    ...
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "<label for=\"max-unavailable\" translate>Maximum Number of Unavailable Pods</label>\n" +
    ...
    "</div>\n" +
    "<div class=\"help-block\" id=\"max-unavailable-help\" translate>\n" +
    ...
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "<label for=\"max-surge\" translate>Maximum Number of Surge Pods</label>\n" +
    ...
    "</div>\n" +
    "<div class=\"help-block\" id=\"max-surge-help\" translate>\n" +
    ...
    "<div ng-if=\"!view.advancedStrategyOptions\"><translate>To set additional parameters or edit lifecycle hooks, view </translate><a href=\"\" ng-click=\"view.advancedStrategyOptions = true\" translate>advanced strategy options.</a></div>\n" +
    ...
    "<label>\n" +
    "<input type=\"checkbox\" ng-model=\"containerConfig.hasDeploymentTrigger\" translate>\n" +
    ...
    "<div class=\"checkbox form-group\">\n" +
    "<label>\n" +
    "<input type=\"checkbox\" ng-model=\"triggers.hasConfigTrigger\" translate>\n" +
    ...
    "</div>\n" +
    "<div class=\"mar-top-lg\">\n" +
    "<div ng-if=\"!view.advancedImageOptions\"><translate>To set secrets for pulling your images from private image registries, view </translate><a href=\"\" ng-click=\"view.advancedImageOptions = true\" translate>advanced image options.</a></div>\n" +
  ...
  $templateCache.put('views/edit/jenkinsfile-examples.html',
    ...
    "</p>\n" +
    "<p>\n" +
    "<translate>Checkout source code and run shell commands on a node labelled </translate><var>maven:</var>\n" +
  ...
  $templateCache.put('views/edit/project.html',
    ...
    "<input class=\"form-control input-lg\" name=\"displayName\" id=\"displayName\" placeholder=\"{{'My Project'|translate}}\" type=\"text\" ng-model=\"editableFields.displayName\">\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "<label for=\"description\" translate>Description</label>\n" +
    "<textarea class=\"form-control input-lg\" name=\"description\" id=\"description\" placeholder=\"{{'A short description.|translate}}\" ng-model=\"editableFields.description\"></textarea>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/edit/route.html',
    ...
    "<breadcrumbs breadcrumbs=\"breadcrumbs\"></breadcrumbs>\n" +
    "<alerts alerts=\"alerts\"></alerts>\n" +
    "<h1 translate>Edit Route {{routeName}}</h1>\n" +
  ...
  $templateCache.put('views/edit/yaml.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "{{updated.resource.kind | humanizeKind | upperFirst}} <strong>{{updated.resource.metadata.name}}</strong> <translate>has changed since you started editing it. You'll need to copy any changes you've made and edit the {{updated.resource.kind | humanizeKind}} again.</translate>\n" +
    "</div>\n" +
    "<div ng-if=\"resourceDeleted\" class=\"alert alert-warning\">\n" +
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "{{updated.resource.kind | humanizeKind | upperFirst}} <strong>{{updated.resource.metadata.name}}</strong> <translate>has been deleted since you started editing it.</translate>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/images.html',
    ...
    "<p translate>No image streams have been added to project {{projectName}}.</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all image streams. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "</span></span><span ng-if=\"imageStream.status.tags.length === 5\">, {{imageStream.status.tags[4].tag}}</span><span ng-if=\"imageStream.status.tags.length > 5\">,\n" +
    "<translate>and {{imageStream.status.tags.length - 4}} others</translate></span>\n" +
    "</td>\n" +
  ...
  $templateCache.put('views/membership.html',
    ...
    "</ui-select-choices>\n" +
    "</ui-select>\n" +
    "<button ng-disabled=\"disableAddForm || (!subject.newRole)\" ng-click=\"addRoleTo(subject.name, subjectKind.name, subject.newRole, subject.namespace)\" class=\"btn btn-default add-role-to\" translate>\n" +
    "Add\n" +
    "</button>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/modals/about-compute-units-modal.html',
    ...
    "<h3>CPU</h3>\n" +
    "<p>\n" +
    "<translate>CPU is often measured in units called </translate><var translate>millicores</var>. <translate>Each millicore is equivalent to </translate><sup>1</sup>&frasl;<sub>1000</sub> <translate>of a CPU&nbsp;core.</translate>\n" +
    "</p>\n" +
    "<pre>\n" +
  ...
  $templateCache.put('views/modals/confirm-replace.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Confirm Replace</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<div ng-if=\"!isList\">\n" +
    "<p>{{resourceKind}} '<strong>{{resourceName}}</strong>' <translate>already exists.</translate></p>\n" +
    ...
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel();\" translate>Cancel</button>\n" +
    "<button class=\"btn btn-primary\" type=\"button\" ng-click=\"replace();\" translate>Replace</button>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/confirm-save-log.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Confirm Save</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p><translate>Save partial log for </translate><strong>{{object.metadata.name}}</strong>?</p>\n" +
    ...
    "<div class=\"mar-top-xl\">\n" +
    "<translate>Learn more about the </translate><a href=\"command-line\" target=\"_blank\" translate>command line tools</a>.\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel()\" translate>Cancel</button>\n" +
    "<button class=\"btn btn-primary\" type=\"button\" ng-click=\"save()\" translate>Save</button>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/confirmScale.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Confirm Scale Down</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p><translate>Scale down {{type}} </translate><strong>{{resource | displayName}}</strong>?</p>\n" +
    "<p>\n" +
    "<translate>Are you sure you want to scale </translate><strong>{{resource | displayName}}</strong> <translate>to 0 replicas? This will stop all pods for the {{type}}.</translate>\n" +
    "</p>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel()\" translate>Cancel</button>\n" +
    "<button class=\"btn btn-danger\" type=\"button\" ng-click=\"confirmScale()\" translate>Scale Down</button>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/debug-terminal.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Debug Container {{container.name}}</h1>\n" +
    "<small class=\"text-muted\">\n" +
    ...
    "<span ng-if=\"containerState.terminated.exitCode\" class=\"text-muted\" translate>Exit code: {{containerState.terminated.exitCode}}</span>\n" +
    "</p>\n" +
    "</div>\n" +
    "</div>\n" +
    "\n" +
    ...
    "<p translate>This temporary pod has a modified entrypoint command to debug a failing container. The pod will be available for one hour and will be deleted when the terminal window is closed.</p>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/modals/delete-resource.html',
    ...
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p><translate>Are you sure you want to delete the {{typeDisplayName || (kind | humanizeKind)}}</translate>\n" +
    ...
    "</span>\n" +
    "<translate>It cannot be undone. Make sure this is something you really want to do!</translate>\n" +
    "</p>\n" +
    ...
    "<translate>Horizontal Pod Autoscaler </translate>'<strong>{{hpaList[0].metadata.name}}</strong>'\n" +
    "</span>\n" +
    "<span ng-if=\"hpaList.length > 1\" translate>\n" +
    ...
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel();\" translate>Cancel</button>\n" +
    "<button ng-disabled=\"typeNameToConfirm && confirmName !== resourceName && confirmName !== displayName\" class=\"btn btn-danger\" type=\"submit\" ng-click=\"delete();\" translate>Delete</button>\n" +
    "</div>\n" +
    "</form>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/edit-pvc-resource.html',
    ...
    "<span class=\"pficon pficon-close\" aria-hidden=\"true\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Expand Persistent Volume Claim</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    ...
    "<span class=\"help-block\" translate>Size is required.</span>\n" +
    "</div>\n" +
    "<div class=\"has-error\" ng-show=\"expandPersistentVolumeClaimForm.capacity.$error.number\">\n" +
    "<span class=\"help-block\" translate>Must be a number.</span>\n" +
    "</div>\n" +
    "<div class=\"has-error\" ng-show=\"expandPersistentVolumeClaimForm .capacity.$error.min\">\n" +
    "<span class=\"help-block\" translate>Must be a positive number.</span>\n" +
    "</div>\n" +
    "<div class=\"has-error\" ng-show=\"expandPersistentVolumeClaimForm.capacity.$error.checkCurrentCapacity\">\n" +
    "<span class=\"help-block\" translate>The requested capacity may not be less than the current capacity.</span>\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Storage quota will be exceeded. </translate><a ng-href=\"project/{{projectName}}/quota\" target=\"_blank\"><translate>View Quota</translate>&nbsp;</a>\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "</fieldset>\n" +
    ...
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel()\" translate>Cancel</button>\n" +
    "<button class=\"btn btn-primary\" type=\"submit\" ng-disabled=\"expandPersistentVolumeClaimForm.$invalid || disableButton\" ng-click=\"expand()\" translate> Expand\n" +
    "</button>\n" +
    "</div>\n" +
    "</ng-form>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/modals/jenkinsfile-examples-modal.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>Jenkinsfile Examples</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<ng-include src=\"'views/edit/jenkinsfile-examples.html'\"></ng-include>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"close()\" translate>Close</button>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/logout.html',
    ...
    "<p><translate>You will be logged out in </translate><strong><time-remaining-from-now end-timestamp=\"endTimestamp\" countdown-duration=\"\"></time-remaining-from-now></strong> <translate>seconds.</translate></p>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
  ...
  $templateCache.put('views/modals/process-or-save-template.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" translate>{{updateTemplate ? \"Update\" : \"Add\"}} Template</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    ...
    "</label>\n" +
    "<div id=\"process-template-help\" class=\"help-block\" translate>\n" +
    ...
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel();\" translate>Cancel</button>\n" +
    "<button class=\"btn btn-primary\" type=\"button\" ng-click=\"continue();\" ng-disabled=\"!templateOptions.process && !templateOptions.add\" translate>Continue</button>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/modals/set-home-page-modal.html',
    ...
    "<translate>Catalog Home (Default)</translate>\n" +
    "</label>\n" +
    "</div>\n" +
    "<div class=\"radio\">\n" +
    "<label>\n" +
    ...
    "<translate>Overview Page for{{availableProjects.length === 1 ? ' ' + (selectedProject | displayName) : ':'}}</translate>\n" +
    "</label>\n" +
  ...
  $templateCache.put('views/monitoring.html',
    ...
    "&ndash;\n" +
    "<translate>{{pod | numContainersReady}}/{{pod.spec.containers.length}} ready</translate>\n" +
    "</small>\n" +
    "</div>\n" +
    "<div class=\"list-pf-additional-content-item\">\n" +
    ...
    "<a ng-href=\"{{replicaSet | donutURL : podsByOwnerUID[replicaSet.metadata.uid]}}\" translate>pods</a>.\n" +
    "</span>\n" +
    "<div class=\"mar-top-lg\" ng-if=\"metricsAvailable\">\n" +
    ...
    "<em>\n" +
    "<div ng-if=\"(statefulSets | size) > 0\" translate>The current filters are hiding all stateful sets.</div>\n" +
    "<span ng-if=\"statefulSetsLoaded && (statefulSets | size) === 0\" translate>There are no stateful sets in this project.</span>\n" +
    "</em>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<translate>To see application logs, view the logs for one of the stateful sets's</translate>\n" +
    "<a ng-href=\"{{set | donutURL : podsByOwnerUID[set.metadata.uid]}}\" translate>pods</a>.\n" +
    "</span>\n" +
    "<div class=\"mar-top-lg\" ng-if=\"metricsAvailable\">\n" +
    ...
    "<span ng-if=\"buildsLoaded && (builds | size) === 0\" translate>There are no builds in this project.</span>\n" +
    "</em>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<osc-git-link uri=\"build.spec.source.git.uri\">{{build.spec.source.git.uri}}</osc-git-link>\n" +
    "</span>\n" +
    "<span ng-if=\"build.spec.source.type && !build.spec.source.git\" translate>\n" +
  ...
  $templateCache.put('views/newfromtemplate.html',
    ...
    "<translate>from parameter</translate><span ng-if=\"image.usesParameters.length > 1\">s</span>\n" +
  ...
  $templateCache.put('views/other-resources.html',
    ...
    "<div ng-if=\"!filterWithZeroResults\">\n" +
    "<h2 translate>No {{resourceName}}.</h2>\n" +
    "<p translate>\n" +
    "No {{resourceName}} have been added to project {{projectName}}.\n" +
    "</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all {{resourceName}}.</translate> <button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview.html',
    ...
    "<button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"overview.clearFilter()\" translate>Clear All Filters</button>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div ng-if=\"!overview.everythingFiltered || overview.viewBy === 'pipeline'\">\n" +
    ...
    "<h2 translate>Other Resources</h2>\n" +
    ...
    "<h2 translate>Mobile Clients</h2>\n" +
    "<div class=\"list-pf\">\n" +
    ...
    "<h2 translate>Virtual Machines</h2>\n" +
    "<div class=\"list-pf\">\n" +
  ...
  $templateCache.put('views/overview/_builds.html',
    ...
    "<div class=\"component-label section-label hidden-xs\" translate>Builds</div>\n" +
  ...
  $templateCache.put('views/overview/_list-row-actions.html',
    ...
    "<translate>Deploy </translate><span ng-if=\"row.isPaused()\" translate>(Paused)</span>\n" +
    "</a>\n" +
    "</li>\n" +
  ...
  $templateCache.put('views/overview/_list-row-content.html',
    ...
    "<span>\n" +
    "<translate>No deployments for </translate><a ng-href=\"{{row.apiObject | navigateResourceURL}}\">{{row.apiObject.metadata.name}}</a>\n" +
    "</span>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_list-row-empty-state.html',
    ...
    "<div ng-if=\"!row.imageChangeTriggers.length\">\n" +
    "<p>\n" +
    "<translate>o deployments for {{row.apiObject.kind | humanizeKind}}</translate>\n" +
    ...
    "<button ng-if=\"row.deploymentConfigsInstantiateVersion | canI : 'create'\" class=\"btn btn-primary\" ng-click=\"row.startDeployment()\" translate>\n" +
    "Start Deployment\n" +
    "</button>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_list-row-expanded.html',
    ...
    "</deployment-metrics>\n" +
    "<h4 class=\"h5\"><translate>Usage</translate> <small translate>Last 15 Minutes</small></h4>\n" +
    "</div>\n" +
    "<div ng-if=\"row.apiObject.kind !== 'Pod'\">\n" +
    ...
    "</deployment-metrics>\n" +
    "<h4 class=\"h5\"><translate>Average Usage </translate><small translate>Last 15 Minutes</small></h4>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_mobile-client-row.html',
    ...
    "<div class=\"empty-state-message text-center\">\n" +
    "<p translate>Add a mobile service to your project. Or connect to external service.</p>\n" +
    "<div class=\"empty-state-message-main-action\">\n" +
    "\n" +
    "<button class=\"btn btn-primary btn-lg\" ng-click=\"row.browseCatalog()\" translate>\n" +
  ...
  $templateCache.put('views/overview/_networking.html',
    ...
    "<div class=\"component-label section-label hidden-xs\" translate>Networking</div>\n" +
    "<div ng-repeat=\"service in networking.rowServices\" class=\"row\">\n" +
    "<div class=\"col-sm-5 col-md-6\">\n" +
    "<div class=\"resource-label\" translate>\n" +
    ...
    "<translate>Route </translate><a ng-href=\"{{route | navigateResourceURL}}\">{{route.metadata.name}}</a><span ng-if=\"route.spec.port.targetPort\" translate>,target port {{route.spec.port.targetPort}}</span>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_notification-icon.html',
    ...
    "Error\n" +
    "</span>\n" +
    "<span ng-if=\"notification.countByType.error !== 1\" translate>\n" +
    "Errors\n" +
    "</span>\n" +
    "</span>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_pipelines.html',
    ...
    "<div class=\"component-label section-label sans-border hidden-xs\" translate>Pipelines</div>\n" +
  ...
  $templateCache.put('views/overview/_service-bindings.html',
    ...
    "<span translate>You must have a bindable service in your namespace in order to create bindings.</span>\n" +
    "<div>\n" +
    "<a href=\"catalog\" translate>Browse Catalog</a>\n" +
    "</div>\n" +
    "</p>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/overview/_service-instance-row.html',
    ...
    "</li>\n" +
    "<li role=\"menuitem\">\n" +
    "<a href=\"\" ng-click=\"row.deprovision()\" role=\"button\" ng-if=\"row.serviceInstancesVersion | canI : 'delete'\" translate>Delete</a>\n" +
    "</li>\n" +
    "</ul>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<span class=\"strong\" translate>The service is not yet ready.</span>\n" +
    "<span class=\"instance-status-message\">\n" +
    ...
    "<div class=\"component-label section-label\" translate>Bindings</div>\n" +
  ...
  $templateCache.put('views/overview/_service-linking-button.html',
    " <a href=\"\" ng-if=\"isPrimary && (services | hashSize) > ((childServices | hashSize) + 1)\" ng-click=\"linkService()\" role=\"button\" ng-attr-title=\"Group service to {{service.metadata.name}}\"><i class=\"fa fa-chain action-button link-service-button\" aria-hidden=\"true\"></i><span class=\"sr-only\" translate>Group service to {{service.metadata.name}}</span></a>\n" +
    "<a href=\"\" ng-if=\"isChild\" ng-click=\"removeLink(service)\" role=\"button\" ng-attr-title=\"Remove {{service.metadata.name}} from service group\"><i class=\"fa fa-chain-broken action-button link-service-button\" aria-hidden=\"true\"></i><span class=\"sr-only\" translate>Remove {{service.metadata.name}} from service group</span></a>"
  );


  $templateCache.put('views/overview/_traffic-percent.html',
    "<div ng-if=\"!totalWeight\" translate>\n" +
    "No Traffic\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/overview/_virtual-machine-row.html',
    ...
    "<div class=\"list-pf-name\">\n" +
    "<h3>\n" +
    "<div class=\"component-label\"><span translate>Virtual Machine</span></div>\n" +
    ...
    "</button>\n" +
    "<ul class=\"dropdown-menu dropdown-menu-right\" uib-dropdown-menu role=\"menu\">\n" +
    "<dropdown-item action=\"row.startOvm()\" enabled=\"{{row.canStartOvm()}}\" translate>Start</dropdown-item>\n" +
    "<dropdown-item action=\"row.restartOvm()\" enabled=\"{{row.canRestartOvm()}}\" translate>Restart</dropdown-item>\n" +
    "<dropdown-item action=\"row.stopOvm()\" enabled=\"{{row.canStopOvm()}}\" translate>Stop</dropdown-item>\n" +
    ...
    "<span class=\"vm-detail-key\" translate>State:</span>\n" +
    "<span vm-state ovm=\"row.apiObject\"></span>\n" +
    "<span class=\"vm-detail-state-actions\">\n" +
    "<span class=\"bar-separated\" ng-if=\"row.canStartOvm()\">\n" +
    "<a href=\"\" ng-click=\"row.startOvm()\" translate>Start</a>\n" +
    "</span>\n" +
    "<span class=\"bar-separated\" ng-if=\"row.canRestartOvm()\">\n" +
    "<a href=\"\" ng-click=\"row.restartOvm()\" translate>Restart</a>\n" +
    "</span>\n" +
    "<span class=\"bar-separated\" ng-if=\"row.canStopOvm()\">\n" +
    "<a href=\"\" ng-click=\"row.stopOvm()\" translate>Stop</a>\n" +
    "</span>\n" +
    "</span>\n" +
    "</div>\n" +
    "<div class=\"word-break\">\n" +
    "<span class=\"vm-detail-key\" translate>Uptime:</span>\n" +
    "<span class=\"vm-detail-value\">{{ row.apiObject._pod | vmPodUptime }}</span>\n" +
    "</div>\n" +
    "<div class=\"word-break\">\n" +
    "<span class=\"vm-detail-key\" translate>Operating System:</span>\n" +
  ...
  $templateCache.put('views/pipelines.html',
    ...
    "<button class=\"btn btn-default\" ng-if=\"buildConfigsInstantiateVersion | canI : 'create'\" ng-click=\"startBuild(buildConfig)\" translate>\n" +
    "Start Pipeline\n" +
    "</button>\n" +
    "</div>\n" +
    "<h2 class=\"mar-top-none\">\n" +
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "<translate>Build config </translate><strong>{{buildConfigName}}</strong> <translate>no longer exists.</translate>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/pods.html',
    ...
    "<div ng-if=\"!filterWithZeroResults\">\n" +
    "<h2 translate>No pods.</h2>\n" +
    "<p translate>No pods have been added to project {{projectName}}.</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all pods. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/projects.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "<translate>The complete list of your projects could not be loaded.</translate>\n" +
    "<translate>Type a project name to go to that project.</translate>\n" +
    "</div>\n" +
    "<form>\n" +
    "<div class=\"form-group\">\n" +
    ...
    "<button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"search.text = ''\" translate>Clear All Filters</button>\n" +
    "</div>\n" +
    ...
    "<translate>Only the first {{limitListTo}} projects are displayed.</translate>\n" +
    "<translate>Filter by keyword or change sort options to see other projects.</translate>\n" +
    "</p>\n" +
    ...
    "</button>\n" +
    "</div>\n" +
    "<p><translate>To learn more, visit the OpenShift </translate><a target=\"_blank\" ng-href=\"{{'' | helpLink}}\" translate>documentation</a>.</p>\n" +
    "<p class=\"projects-instructions\" ng-if=\"canCreate === false\" ng-include=\"'views/_cannot-create-project.html'\"></p>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/quota.html',
    ...
    "<h3 class=\"text-center\"><translate>Memory </translate><small translate>Request</small></h3>\n" +
    ...
    "<h3 class=\"text-center\"><translate>Memory </translate><small translate>Limit</small></h3>\n" +
  ...
  $templateCache.put('views/secrets.html',
    ...
    "<p translate>No secrets have been added to project {{projectName}}.</p>\n" +
    "<p ng-if=\"project && (secretsVersion | canI : 'create')\">\n" +
    "<a ng-href=\"project/{{project.metadata.name}}/create-secret\" class=\"btn btn-primary btn-lg\" translate>Create Secret</a>\n" +
    "</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all secrets. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/service-instances.html',
    ...
    "<div ng-if=\"!filterWithZeroResults\">\n" +
    "<h2 translate>No provisioned services.</h2>\n" +
    "<p translate>No provisioned services have been added to project {{projectName}}.</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all provisioned services. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "</td>\n" +
    "<td data-title=\"Created\">\n" +
    "<span am-time-ago=\"serviceInstance.metadata.creationTimestamp\" am-without-suffix=\"true\"></span> <translate>ago</translate>\n" +
    "</td>\n" +
    ...
    "</div>\n" +
    "</div>\n" +
    "<div ng-if=\"!bindingsByInstanceRef[serviceInstance.metadata.name].length\" translate>\n" +
    "No bindings\n" +
    "</div>\n" +
    "</td>\n" +
    "</tr>\n" +
  ...
  $templateCache.put('views/services.html',
    ...
    "<p ng-if=\"!servicesLoaded\" translate>\n" +
    "Loading...\n" +
    "</p>\n" +
    "<div ng-if=\"servicesLoaded\" class=\"empty-state-message text-center\">\n" +
    "<div ng-if=\"!filterWithZeroResults\">\n" +
    "<h2 translate>No services.</h2>\n" +
    "<p translate>No services have been added to project {{projectName}}.</p>\n" +
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all services.</translate> <button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "</span></span><span ng-if=\"service.status.loadBalancer.ingress.length === 5\">, {{service.status.loadBalancer.ingress[4].ip}}</span><span ng-if=\"service.status.loadBalancer.ingress.length > 5\" translate>,and {{service.status.loadBalancer.ingress.length - 4}} others</span>\n" +
    "</td>\n" +
    "<td data-title=\"Ports\">\n" +
    ...
    "</span></span><span ng-if=\"service.spec.ports.length === 5\">, {{service.spec.ports[4].port}}/{{service.spec.ports[4].protocol}}</span><span ng-if=\"service.spec.ports.length > 5\" translate>,and {{service.spec.ports.length - 4}} others</span>\n" +
    "</td>\n" +
  ...
  $templateCache.put('views/set-limits.html',
    ...
    "<div class=\"help-block\">\n" +
    "<translate>Resource limits control how much </translate><span ng-if=\"!hideCPU\" translate>CPU and</span> <translate>memory a container will consume on a node.</translate>\n" +
  ...
  $templateCache.put('views/storage.html',
    ...
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2><translate>The filter is hiding all persistent volume claims. </translate><button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/util/error.html',
    ...
    "</div>\n" +
    "<br>\n" +
    "<div><translate>Return to the </translate><a href=\"\" ng-click=\"reloadConsole()\" translate>console</a>.</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/util/oauth.html',
    ...
    "<h1><translate>Logging in</translate>&hellip;</h1>\n" +
    "<p><translate>Please wait while you are logged in</translate>&hellip;</p>\n" +
    "</div>\n" +
    "<div ng-if=\"confirmUser && !overriddenUser\">\n" +
    "<h1 translate>Confirm Login</h1>\n" +
    "<p><translate>You are being logged in as </translate><code>{{confirmUser.metadata.name}}</code>.</p>\n" +
    ...
    "</div>\n" +
    "<div ng-if=\"confirmUser && overriddenUser\">\n" +
    "<h1 translate>Confirm User Change</h1>\n" +
    "<p><translate>You are about to change users from </translate><code>{{overriddenUser.metadata.name}}</code> to <code>{{confirmUser.metadata.name}}</code>.</p>\n" +
  ...
  $templateCache.put('components/osc-webhook-triggers/osc-webhook-triggers.html',
    ...
    "<span class=\"sr-only\" translate>Toggle Token Visibility</span>\n" +
    "</button>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"form-row-controls\">\n" +
    ...
    "<span class=\"pficon pficon-close\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Remove Webhook trigger</span>\n" +
    "</button>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"has-warning\" ng-if=\"trigger.isDuplicate\">\n" +
    "<span class=\"help-block\" translate>A {{trigger.data.type}} webhook trigger referencing the secret {{(trigger | getWebhookSecretData).secretReference.name}} already exists.</span>\n" +
    "</div>\n" +
    "</div>\n" +
